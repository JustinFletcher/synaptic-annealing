...
%An alternative, isotropic classical neightborhood function is given by  \begin{align}\label{eq:classical_isotropic_neighborhood}\mathcal{N}_{c,I} (\boldsymbol{\mathcal{W}}) = \boldsymbol{\mathcal{W}} + \alpha\boldsymbol{\mathcal{R}_n} \boldsymbol{1} \end{align}
