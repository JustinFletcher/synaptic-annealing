function nFoldCrossValidateBackpropPar(numFolds, synMatConfigVec, annealingFunction, convCriterion, cutoffEpochs, perturbSynapses, updateState, errorFunction, reportErrorFunction, initTemperature, initLearnRate, actFun, data, inputCols, outputCols)
    ...
    for fold in 1:numFolds
        ...
        net = init_network(synMatConfigVec)

        # Spawn an annealing task.
        ref = @spawn backpropTraining(convCriterion, cutoffEpochs, perturbSynapses, updateState, errorFunction, reportErrorFunction, initTemperature, initLearnRate, net, actFun, trainData, valData, inputCols, outputCols)
